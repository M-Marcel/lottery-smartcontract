...
//                   const playerFromContract = await raffle.getPlayers(0)
//                   assert.equal(playerFromContract, deployer)
//                   //   assert.equal(playerFromContract, player)
//               })
//               it("emits event on enter", async function () {
//                   await expect(raffle.enterRaffle({ value: raffleEntranceFee })).to.emit(
//                       raffle,
...
//           //           // We will have to wait for the fulfillRandomWords to be called
//           //           await new Promise(async (resolve, reject) => {
//           //               accountConnectedRaffle.once("WinnerPicked", async () => {
//           //                   // raffle.once("WinnerPicked", async () => {
//           //                   console.log("WinnerPicked event fired!")
//           //                   try {
//           //                       console.log(recentWinner)
...
//           //                       console.log(accounts[1].address)
//           //                       console.log(accounts[3].address)
//           //                       const recentWinner = await accountConnectedRaffle.getRecentWinner()
//           //                       const raffleState = await accountConnectedRaffle.getRaffleState()
//           //                       const endingTimeStamp =
//           //                           await accountConnectedRaffle.getLatestTimeStamp()
//           //                       const numPlayers = await accountConnectedRaffle.getNumberOfPlayers()
//           //                       const winnerEndingBalance = await accounts[2].getBalance()
//           //                       assert.equal(numPlayers.toString(), "0")
//           //                       assert.equal(raffleState.toString(), "0")
//           //                       //   assert(endingTimeStamp > startingTimeStamp)
...
//           //           // Setting up the listener
//           //           // below, we will fire the event, and the listener will pick it up, and resolve
//           //           const tx = await accountConnectedRaffle.performUpkeep([])
//           //           const txReceipt = await tx.wait(1)
//           //           const winnerStartingBalance = await accounts[2].getBalance()
//           //           await vrfCoordinatorV2Mock.fulfillRandomWords(
//           //               txReceipt.events[1].args.requestId,
//           //               accountConnectedRaffle.address
//           //           )
//           //       })
